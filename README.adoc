...
The Crysgnar project is a Freedoom fork who have the goal to be a
standalone first shooter game for the Doom engine.
You can see below all those who need to know about Freedoom.
